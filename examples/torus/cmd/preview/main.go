// cmd/preview — the standalone preview + frame-renderer for the braille torus.
//
// This is scripts/preview/ (main.go.tmpl + size_*.go) with render() wired to
// torus.Frame. The two size_*.go files are verbatim — they give the live loop the real
...
func main() {
	// torus is a pure, seamlessly looping field: frame N is a function of (w, h, N) alone.
